...
import { ListContainer, ProducerCard, ProducerInfo, ProducerActions } from './ProducerList.styled';
      ...
      {producers.map(producer => (
        <ProducerCard key={producer.id}>
          ...
          <ProducerActions>
            ...
            {onEdit && (
              <ActionButton variant='secondary' size='small' onClick={() => onEdit(producer.id)}>
                Editar
              </ActionButton>
            )}
            {onDelete && (
              <ActionButton variant='danger' size='small' onClick={() => onDelete(producer.id)}>
                Excluir
              </ActionButton>
            )}
          </ProducerActions>
